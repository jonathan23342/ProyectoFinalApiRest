<?php
    ...
    $pdf->MultiCell(0,5,utf8_decode(strtoupper("PANAMEX")),0,'C',false);
    $pdf->SetFont('Arial','',9);
    // $pdf->MultiCell(0,5,utf8_decode("RUC: 0000000000"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("Av, José Francisco Ruiz Massieu No. 5, Fracc.villa Moderna, 39090 Chilpancingo de los Bravo, Guerrero"),0,'C',false);
    ...
    $pdf->MultiCell(0,5,utf8_decode("Fecha: ".date("d/m/Y h:i:s", strtotime("now"))),0,'C',false);
    ...
    $pdf->MultiCell(0,5,utf8_decode("DEPOSITO"),0,'C',false);
    $pdf->SetFont('Arial','',9);
    $pdf->MultiCell(0,5,utf8_decode("No. cuenta remitente: 3243"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("No. cuenta destinatario: 1231"),0,'C',false);
    ...
    // $pdf->MultiCell(18,5,utf8_decode(""),0,'C');
    // $pdf->MultiCell(22,5,utf8_decode("CANTIDAD DEPOSITADA: $0000"),0,'C', false);
    $pdf->MultiCell(0,5,utf8_decode("CANTIDAD DEPOSITADA: $0000"),0,'C',false);
    ...
    $pdf->MultiCell(0,5,utf8_decode("SALDO ACTUAL: $0000"),0,'C',false);

    $pdf->Ln(10);

    $pdf->MultiCell(0,5,utf8_decode("Este recibo es comprobante de su deposito"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode(""),0,'C',false);

    $pdf->SetFont('Arial','B',9);

    $pdf->MultiCell(0,5,utf8_decode("*** ESTIMADO CLIENTE***"),0,'C',false);


    $pdf->SetFont('Arial','',9);
    $pdf->MultiCell(0,5,utf8_decode("El cliente acepta y reconoce que la información proporcionada es correcta, por lo que el banco no sera responsable por aquellos datos erroneos que se hayan proporcionado"),0,'C',false);
    // $pdf->MultiCell(0,7,utf8_decode("El cliente acepta y reconoce"),'',0,'C');
    // $pdf->MultiCell(0,7,utf8_decode("El cliente acepta y reconoce que la informacion proporcionada es correcta, por lo que el banco no sera responsable por aquellos datos erroneos que se hayan proporcionado"),'',0,'C');
