...
$saldo = $_GET['saldo'];
    ...
    $pdf->MultiCell(0,5,utf8_decode("RETIRO"),0,'C',false);
    $pdf->SetFont('Arial','',9);
    $pdf->MultiCell(0,5,utf8_decode("No. de cuenta: $cuenta"),0,'C',false);
    ...
    $pdf->MultiCell(0,5,utf8_decode("CANTIDAD RETIRADA: $cantidad"),0,'C',false);
    ...
    $pdf->MultiCell(0,5,utf8_decode("SALDO ACTUAL: $saldo"),0,'C',false);

    $pdf->Ln(10);

    $pdf->MultiCell(0,5,utf8_decode("Este recibo es comprobante de su retiro"),0,'C',false);
